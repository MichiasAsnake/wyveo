...
function ShinyLink({ label, className, children, ...props }: ShinyLinkProps) {
    return (
        <a
            className={cn(
                "group relative inline-flex items-center gap-2 h-12 px-8 rounded-lg overflow-hidden transition-all duration-500",
                className
            )}
            {...props}
        >
